    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            <li>
                ...
                <ul>
                    <li> <a href="../home.php"><i class="bx bx-right-arrow-alt"></i>eCommerce</a>
                    </li>
            ...
            <li>
                ...
                <ul>
                    <li> <a href="store.php"><i class="bx bx-right-arrow-alt"></i>Products</a>
                    </li>
                    <li> <a href="product.php"><i class="bx bx-right-arrow-alt"></i>Product Details</a>
                    </li>
                    <li> <a href="../admin/add-product.php"><i class="bx bx-right-arrow-alt"></i>Add New Products</a>
                    </li>
                    <li> <a href="orders.php"><i class="bx bx-right-arrow-alt"></i>Orders</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li> <a href="../user/auth/sign-in.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>Sign In</a>
                    </li>
                    <li> <a href="../user/auth/sign-up.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>Sign Up</a>
                    </li>
                    <li> <a href="temp/sign-in-with-header-footer.html" target="_blank"><i class="bx bx-right-arrow-alt"></i>Sign In with Header & Footer</a>
                    </li>
                    <li> <a href="temp/sign-up-with-header-footer.html" target="_blank"><i class="bx bx-right-arrow-alt"></i>Sign Up with Header & Footer</a>
                    </li>
                    <li> <a href="../user/auth/forgot-password.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>Forgot Password</a>
                    </li>
                    <li> <a href="../user/auth/reset-password.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>Reset Password</a>
                    </li>
                    <li> <a href="../user/auth/lock-screen.html" target="_blank"><i class="bx bx-right-arrow-alt"></i>Lock Screen</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li> <a href="../errors/404.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>404 Error</a>
                    </li>
                    <li> <a href="../errors/500.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>500 Error</a>
                    </li>
                    <li> <a href="../usefuls/coming-soon.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>Coming Soon</a>
                    </li>
                    <li> <a href="../usefuls/blank-page.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>Blank Page</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li> <a href="../usefuls/google-maps.php"><i class="bx bx-right-arrow-alt"></i>Google Maps</a>
                    </li>
                    <li> <a href="../usefuls/vector-maps.php"><i class="bx bx-right-arrow-alt"></i>Vector Maps</a>
                    </li>
                </ul>
            </li>
