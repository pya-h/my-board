                        ...
                        <div class="row mt-5 w-100">
                            <div class="card radius-10 w-100  mt-5 py-3 overflow-hidden">
                                <div dir="rtl" class="card-body text-center error">
                                    <h4 class="text-center text-dark" style="font-weight: bolder">خطای اتصال به سرور</h4>
                                    <div class="d-flex align-items-center">
                                        <div class="card-footer mx-auto bg-transparent border-top-0">
                                            <h4>خطایی در برقراری ارتباط با سرور بوجود آمده است.</h4>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="card-footer mx-auto bg-transparent border-top-0">
                                            <h4>لطفا لحظاتی دیگر مجددا تلاش کنید!</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
